...
class SalesInvoice(SalesInvoiceController):
    ...
    def get_mapped_data(self):
        ...
        data["invoiceRefNo"] = ""
        data["sourceInvoiceNo"] = self.get("ctpl_ref") or self.name
    ...
    def get_items(self):
        ...
        if settings.send_single_item:
            ...
            item_data_single = {
                ...
                "totalValues": self.round_half_up(self.total + tax_amount + fedpayable, 2),
                "valueSalesExcludingST": self.round_half_up(self.total, 2),
                "fixedNotifiedValueOrRetailPrice": 0,
                "salesTaxApplicable": tax_amount + fedpayable if tax_amount > 0 else 0,
            ...
            for item in self.items:
                ...
                item_data = {
                    ...
                    "totalValues": self.round_half_up(item.amount + tax_amount + fedpayable, 2),
